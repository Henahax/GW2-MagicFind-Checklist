...
const App: React.FC = () => {
  ...
  const calculateSum = () => {
    ...
    tableRows.forEach((row, index) => {
      ...
      // Update the state of the individual checkbox
      setCheckboxStates((prevCheckboxStates) => {
        const updatedCheckboxStates = [...prevCheckboxStates];
        updatedCheckboxStates[index] = { id: index, checked: checkbox?.checked || false };
  ...
  const getColourClass = (value: number) => {
    if (value < 750) {
      return 'red';
    }
    return 'green';
  ...
  useEffect(() => {
    const value = calculateSum();
    setSumValue(value);
    setColourClass(getColourClass(value));
  }, [checkboxStates, numberValue]);
  ...
  const handleCheckboxChange = (index: number) => (event: ChangeEvent<HTMLInputElement>) => {
    setCheckboxStates((prevCheckboxStates) => {
      const updatedCheckboxStates = [...prevCheckboxStates];
      updatedCheckboxStates[index] = { id: index, checked: event.target.checked };
      return updatedCheckboxStates;
    });
  };
    ...
    <>
      ...
      <table id="mainTable">
        ...
        <tbody id="tableBody">
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(1)} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(2)} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(3)} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(4)} /></td>
            <td className="value">10</td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(5)} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(6)} /></td>
            <td className="value">15</td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(7)} /></td>
            <td className="value">10</td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(8)} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(9)} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(10)} /></td>
            <td className="value">10</td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(11)} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(12)} /></td>
            <td className="value">100</td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(13)} /></td>
          ...
          <tr>
            <td><input type="checkbox" onChange={handleCheckboxChange(14)} /></td>
            <td className="value">50</td>
